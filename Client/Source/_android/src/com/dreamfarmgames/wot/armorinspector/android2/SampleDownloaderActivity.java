...
public class SampleDownloaderActivity extends Activity implements IDownloaderClient {
    ...
    private static boolean mNativeActivityStarted = false;
    ...
    private static final XAPKFile[] xAPKS = {
            new XAPKFile(
                    ...
                    2, // the version of the APK that the file was uploaded
                       // against
                    199744141L // the length of the file in bytes
            ),
            new XAPKFile(
                    false, // true signifies a main file
                    2, // the version of the APK that the file was uploaded
                       // against
                    8037734L // the length of the file in bytes
            )
    };
        ...
        AsyncTask<Object, DownloadProgressInfo, Boolean> validationTask = new AsyncTask<Object, DownloadProgressInfo, Boolean>() {
            ...
            protected void onPostExecute(Boolean result) {
                if (result) {
                    ...
                    if (!mNativeActivityStarted)
                    {
                        mNativeActivityStarted = true;
                        //Log.i(LOG_TAG, "Starting native activity");
                        SampleDownloaderActivity.this.runOnUiThread(new Runnable(){
                            public void run() {
                                Intent i = new Intent(SampleDownloaderActivity.this, NativeActivity.class);
                                SampleDownloaderActivity.this.startActivity(i);
                            }
                        });
                    }
                } else {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!expansionFilesDelivered()) {
            ...
            try {
                ...
                //Log.e(LOG_TAG, Integer.toString(startResult));
    ...
    public void onDownloadStateChanged(int newState) {
        ...
        //Log.e(LOG_TAG, Integer.toString(newState));
        switch (newState) {
